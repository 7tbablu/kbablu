...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex dark:text-[#935efdf9] text-[#3d2272]">
      ...
      >
        {children}
        <ChevronDownIcon className=" dark:text-[#7550bdf9] text-[#3d2272] pointer-events-none size-6 shrink-0 translate-y-0.5 transition-transform duration-200" />
      </AccordionPrimitive.Trigger>
